...
public class WebElementUtils {
    ...
    public String getTextWithoutSubElements(WebElement element) {
        ...
        for(Iterator var3 = element.findElements(By.xpath(".//*")).iterator(); var3.hasNext(); fullText = fullText.replace(subElement.getText().trim(), "")) {
            subElement = (WebElement)var3.next();
        }
